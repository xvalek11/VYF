...
static void fft_dif_iter(float*, unsigned long);
static void fft_dif_iter_seq(float*, unsigned long);
static void fft_dif_rec(float*, unsigned long, int);

static void ifft_dit_iter(float*, unsigned long);
static void ifft_dit_iter_seq(float*, unsigned long);
static void ifft_dit_rec(float*, unsigned long, int);

static void fht_dif_iter(float*, unsigned long);
static void fht_dif_iter_seq(float*, unsigned long);
static void fht_dif_rec(float*, unsigned long, int);

static void fht_dit_iter(float*, unsigned long);
static void fht_dit_iter_seq(float*, unsigned long);
static void fht_dit_rec(float*, unsigned long, int);
...
void fft_dif(float *z, unsigned long n)
{
    fft_dif_rec(z, n, 1);
    return;
}   /* fft_dif() */
...
void ifft_dit(float *z, unsigned long n)
{
    ifft_dit_rec(z, n, 1);
    return;
}   /* ifft_dit() */
...
void fht_dif(float *x, unsigned long n)
{
    fht_dif_rec(x, n, 1);
    return;
}   /* fht_dif() */
...
void fht_dit(float *x, unsigned long n)
{
    fht_dit_rec(x, n, 1);
    return;
}   /* fht_dit() */
...
void hilbert(float *z, unsigned long n)
{
    float x;
    unsigned long i, n2;
...
static void fft_dif_iter(float *z, unsigned long n)
{
    unsigned long i, n2;
...
static void fft_dif_iter_seq(float *z, unsigned long n)
{
    unsigned long i, n2;
...
static void fft_dif_rec(float *z, unsigned long n, int nbranch)
{
    float a, b, c, s, t;
    unsigned long nh, kr;
    ...
    if (n == 1)
        return;
    if (n <= (unsigned long)(L1_CACHE_BYTES / (2 * sizeof(float)))) {
        if (FFT_UNIT_STRIDE)
...
static void ifft_dit_iter(float *z, unsigned long n)
{
    unsigned long i, n2;
...
static void ifft_dit_iter_seq(float *z, unsigned long n)
{
    unsigned long i, n2;
...
static void ifft_dit_rec(float *z, unsigned long n, int nbranch)
{
    float a, b, c, s, t;
    unsigned long  nh, kr;
...
static void fht_dif_iter(float *x, unsigned long n)
{
    unsigned long m;
...
static void fht_dif_iter_seq(float *x, unsigned long n)
{
    unsigned long m;
...
static void fht_dif_rec(float *x, unsigned long n, int nbranch)
{
    float a, b, c, s, t;
    ...
    if (n == 1)
        return;
    if (n <= (unsigned long)(L1_CACHE_BYTES / sizeof(float))) {
        if (FHT_UNIT_STRIDE)
...
static void fht_dit_iter(float *x, unsigned long n)
{
    unsigned long m;
...
static void fht_dit_iter_seq(float *x, unsigned long n)
{
    unsigned long m;
...
static void fht_dit_rec(float *x, unsigned long n, int nbranch)
{
    float a, b, c, s, t;
    unsigned long j, jmax, k, nh, nq;
...
void bitrev_permute(float *z, unsigned long n)
{
    unsigned long i;
    unsigned int ldn = 0;
    unsigned int rshift;
...
void bitrev_permute_real(float *x, unsigned long n)
{
    unsigned long i;
    unsigned int ldn = 0;
    unsigned int rshift;
